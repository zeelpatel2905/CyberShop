...
<html>
    <head>
        <meta charset="UTF-8">
        <title>CyberShop - Employee Login</title>
    </head>
    <body>
        <div id="content">
            <h1>Login</h1>
                ...
                <center>
                    <form action="login.php" method="post">
                        <table>
                            ...
                            <tr>
                                <td></td>
                                <td><a href="../forgotPassword.php?role=Employee">Forgot Password</a></td>
                            </tr>
                            <tr>
                                <td></td>
                    ...
                    if (isset($_REQUEST["loginu"]))
                    {
                        ...
                        {
                            $query = "select * from tbluser where EmailID='$uname' and Password=md5('$password') and UserType='$utype'";
                            ...
                            } else
                            {
                                if (isset($_REQUEST["remember"]))
                                {
                                    ...
                                    //setcookie("Cuser",$credentials,time()+60*60*24);
                                }
                                $_SESSION["user"] = $uname;
                                $_SESSION["role"] = $utype;
